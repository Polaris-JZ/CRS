...
if __name__ == '__main__':
    ...
    process('valid_data_dbpedia_review.jsonl', 'valid_data_processed.jsonl', item_set)
    process('test_data_dbpedia_review.jsonl', 'test_data_processed.jsonl', item_set)
    process('train_data_dbpedia_review.jsonl', 'train_data_processed.jsonl', item_set)
