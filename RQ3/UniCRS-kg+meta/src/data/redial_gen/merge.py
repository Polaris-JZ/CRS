...
for split in ['train', 'valid', 'test']:
    raw_file_path = f"/projects/prjs1158/KG/redail/UniCRS_update/src/data/redial/{split}_data_processed.jsonl"
    raw_file = open(raw_file_path, encoding='utf-8')
    raw_data = raw_file.readlines()
    # print(len(raw_data))

    gen_file_path = f"/projects/prjs1158/KG/redail/UniCRS_update/src/save/{dataset}/{gen_file_prefix}_{split}.jsonl"
